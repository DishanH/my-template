        ...
        <View style={styles.content}>
          <View style={styles.header}>
            ...
            <Text style={[styles.subtitle, { color: colors.textSecondary, fontSize: fontSize.normal }]}>
              Sign up to start improving your writing
            </Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            >
              {isLoading ? (
                ...
                <Text style={[styles.buttonText, { fontSize: fontSize.normal }]}>Create Account</Text>
              )}
            </TouchableOpacity>
          ...
          <Text style={[styles.termsText, { color: colors.textSecondary, fontSize: fontSize.small }]}>
